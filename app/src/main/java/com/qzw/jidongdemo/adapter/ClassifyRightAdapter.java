...
public class ClassifyRightAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ClassfiygvAdapter classfiygvAdapter = new ClassfiygvAdapter(context, list1);
        classifyRightViewHolder.gvRightShow.setAdapter(classfiygvAdapter);
        ...
        classfiygvAdapter.setOnItemClickListener(new ClassfiygvAdapter.OnItemClickListener() {
            @Override
            public void onclick(int pcid, String pscid) {
                onClickItemListener.onClick(pcid,pscid);
            }
        });
