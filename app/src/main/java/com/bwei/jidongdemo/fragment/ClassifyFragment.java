...
import com.bwei.jidongdemo.adapter.ClassifyLeftAdapter;
import com.bwei.jidongdemo.adapter.ClassifyRightAdapter;
...
public class ClassifyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.layout_classify_fragment, container, false);
